...
#################################################################### Start ##########################################################################################################################################
#################################################################### Start ##########################################################################################################################################
AAVEED_Down    <- read.table("H3K27ac/Down/H3K27ac_AAVEED_center_heatmap/a.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
AAVGFP_Down    <- read.table("H3K27ac/Down/H3K27ac_AAVGFP_center_heatmap/a.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
ctrl_Down      <- read.table("H3K27ac/Down/H3K27ac_ctrl_center_heatmap/a.xls",      header=TRUE,   sep="",   quote = "",   comment.char = "")
KO_Down        <- read.table("H3K27ac/Down/H3K27ac_KO_center_heatmap/a.xls",        header=TRUE,   sep="",   quote = "",   comment.char = "")
...
Four_NOL( AAVEED_Down,   AAVGFP_Down,   ctrl_Down,    KO_Down,   paste(AllResults_g, "/11-A-H3K27ac-Down-Average.svg", sep=""),  "KO Down (95 Genes)",   Ymin_Local=0,  Ymax_Local=7)                     
...
#################################################################### Start ##########################################################################################################################################
#################################################################### Start ##########################################################################################################################################
AAVEED_Retain    <- read.table("H3K27ac/Nochange/H3K27ac_AAVEED_center_heatmap/a.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
AAVGFP_Retain    <- read.table("H3K27ac/Nochange/H3K27ac_AAVGFP_center_heatmap/a.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
ctrl_Retain      <- read.table("H3K27ac/Nochange/H3K27ac_ctrl_center_heatmap/a.xls",      header=TRUE,   sep="",   quote = "",   comment.char = "")
KO_Retain        <- read.table("H3K27ac/Nochange/H3K27ac_KO_center_heatmap/a.xls",        header=TRUE,   sep="",   quote = "",   comment.char = "")
...
Four_NOL( AAVEED_Retain,   AAVGFP_Retain,   ctrl_Retain,    KO_Retain,   paste(AllResults_g, "/11-B-H3K27ac-Retain-Average.svg", sep=""),  "KO Retain (5681 Genes)",   Ymin_Local=0,  Ymax_Local=7)                     
...
#################################################################### Start ##########################################################################################################################################
#################################################################### Start ##########################################################################################################################################
AAVEED_Up    <- read.table("H3K27ac/Up/H3K27ac_AAVEED_center_heatmap/a.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
AAVGFP_Up    <- read.table("H3K27ac/Up/H3K27ac_AAVGFP_center_heatmap/a.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
ctrl_Up      <- read.table("H3K27ac/Up/H3K27ac_ctrl_center_heatmap/a.xls",      header=TRUE,   sep="",   quote = "",   comment.char = "")
KO_Up        <- read.table("H3K27ac/Up/H3K27ac_KO_center_heatmap/a.xls",        header=TRUE,   sep="",   quote = "",   comment.char = "")
...
Four_NOL( AAVEED_Up,   AAVGFP_Up,   ctrl_Up,    KO_Up,   paste(AllResults_g, "/11-C-H3K27ac-Up-Average.svg", sep=""),  "KO Up (283 Genes)",   Ymin_Local=0,  Ymax_Local=7)                     
